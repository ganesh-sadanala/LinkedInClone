window.onload = () => {
  ...
  let userImage = document.getElementById("Post-user-img");
  let userName = document.getElementById("Post-user-name");
  let userDesc = document.getElementById("Post-user-desc");
  let userContent = document.getElementById("Post-content-text");
