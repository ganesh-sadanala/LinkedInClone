...
window.onload = () => {
  ...
  for (var i = 0; i < linkedInPosts.length; i++) {
    ...
    let shareT = document.createElement("p");
    let sendT = document.createElement("p");
    like.className = "Post-like";
    comment.className = "Post-comment";
    share.className = "Post-share";
    send.className = "Post-send";
    likeT.className = "Post-text";
    commentT.className = "Post-text";
    shareT.className = "Post-text";
    sendT.className = "Post-text";
    likeDiv.className = "Post-react";
    commentDiv.className = "Post-react";
    shareDiv.className = "Post-react";
    sendDiv.className = "Post-react";
    like.src = "./assets/like.svg";
    likeT.innerHTML = "Like";
    likeDiv.appendChild(like);
    likeDiv.appendChild(likeT);
    comment.src = "./assets/comment.svg";
    commentT.innerHTML = "Comment";
    commentDiv.appendChild(comment);
    commentDiv.appendChild(commentT);
    share.src = "./assets/share.svg";
    shareT.innerHTML = "Share";
    shareDiv.appendChild(share);
    shareDiv.appendChild(shareT);
    send.src = "./assets/send.svg";
    sendT.innerHTML = "Send";
    sendDiv.appendChild(send);
    sendDiv.appendChild(sendT);
    reactions.appendChild(likeDiv);
    reactions.appendChild(commentDiv);
    reactions.appendChild(shareDiv);
    reactions.appendChild(sendDiv);
